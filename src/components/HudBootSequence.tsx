...
export function HudBootSequence({ onBootComplete }: { onBootComplete?: () => void }) {
  ...
  return (
    <>
      {/* ── Trigger Button + Cat Companion ── */}
      <div className="absolute right-[8%] top-1/2 z-20 hidden -translate-y-1/2 flex-col items-center gap-3 lg:flex">
        {/* Cat roams freely around this anchor — overflow:visible lets it wander */}
        <div className="relative flex items-center justify-center" style={{ width: 0, height: 0, overflow: "visible" }}>
